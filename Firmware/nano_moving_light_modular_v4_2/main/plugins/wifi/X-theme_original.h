...
// ── Theme: Original — pre-v4.2 dark design ───────────────────────
...
header{padding:12px 16px;border-bottom:1px solid var(--border);background:var(--surface);}
...
.motion-row{gap:10px;margin-bottom:14px;}
...
.cue-item{gap:8px;padding:10px 12px;background:var(--surface2);border:1px solid var(--border);border-radius:4px;}
...
.seq-buttons .btn{padding:12px;text-align:center;}
...
#toast{background:var(--surface2);border:1px solid var(--border);color:var(--text);padding:10px 18px;font-family:var(--mono);font-size:12px;border-radius:4px;transition:opacity 0.2s;}
