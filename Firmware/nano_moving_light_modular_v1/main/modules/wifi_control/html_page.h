...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .cue-item{display:flex;align-items:center;gap:8px;padding:10px 12px;background:var(--surface2);border:1px solid var(--border);border-radius:4px;}
...
<div class="main">
  ...
  <div class="panel area-future">
    <div class="panel-title">// Module Slot</div>
    <div class="future-placeholder">
      <span>// RESERVED</span>
      <span style="font-size:10px;opacity:0.5">import from external file</span>
    </div>
    <!-- To add a module, import its HTML here: -->
    <!-- <div id="module-container"></div>        -->
    <!-- Example file: modules/my_module.html    -->
    <!-- Load via: fetch('my_module.html')...    -->
  </div>
